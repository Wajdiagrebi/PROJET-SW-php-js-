...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($email) || empty($password)) {
        ...
        $name = "SELECT name  FROM clients WHERE email = ?";
                    ...
                    <div class="containerlogin">
                        <div class="row">
                            <div class="col-lg-10 col-xl-12 mx-auto">
                                <h1 class="display-2">Welcome to our Team</h1>
                                ...
                                <form action="" method="post">
                                    ...
                                    <p> <a href="login_admin.php">Login as adminisrator</a></p>
